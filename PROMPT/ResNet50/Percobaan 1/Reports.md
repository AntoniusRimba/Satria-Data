...
Menyusun ringkasan ilmiah (Scientific Report) dari seluruh proses eksperimen **Transfer Learning ResNet50** pada kasus klasifikasi material sampah Big Data Challenge SATRIA DATA 2026.
...
Bandingkan ResNet50 terhadap CNN Baseline berdasarkan:
...
Jelaskan apakah penggunaan Transfer Learning memberikan peningkatan performa dibandingkan baseline.

---

### 9. Kelebihan

Tuliskan kelebihan implementasi ResNet50 berdasarkan hasil eksperimen.
...
- Apakah ResNet50 lebih baik daripada CNN Baseline?
...
- Melakukan Fine-Tuning ResNet50
- Hyperparameter Tuning
- Mencoba EfficientNet-B0
...
Tunggu evaluasi dan persetujuan sebelum melanjutkan ke **ResNet50 Fine-Tuning (Experiment 02)** atau eksperimen model berikutnya.